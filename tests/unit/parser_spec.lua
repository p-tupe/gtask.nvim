...
describe("parser module", function()
  ...
  describe("parse_task_line", function()
    ...
    it("should parse completed task", function()
      local indent, checkbox, title, due_date = parser.parse_task_line("- [x] Buy milk")
    ...
    it("should parse indented task (2 spaces)", function()
      local indent, checkbox, title, due_date = parser.parse_task_line("  - [ ] Subtask")
    ...
    it("should parse deeply indented task (4 spaces)", function()
      local indent, checkbox, title, due_date = parser.parse_task_line("    - [ ] Deep subtask")
    ...
    it("should handle task with multiple pipes in title", function()
      local indent, checkbox, title, due_date = parser.parse_task_line("- [ ] Research A | B options | 2025-01-15")
