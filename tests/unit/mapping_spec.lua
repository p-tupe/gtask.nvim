...
describe("mapping module", function()
  ...
  describe("find_nearby", function()
    it("should find task at exact position", function()
      local map = { tasks = {}, context_index = {} }
      mapping.register_task(map, "Shopping|/file.md:10:top", "google123", "Shopping", "Buy milk", "/file.md", 10, nil, "Shopping||||Buy milk")
    ...
    it("should respect custom range", function()
      ...
      local found_key, found_data, offset = mapping.find_nearby(map, "Shopping", "/file.md", 13, nil, 2)
  ...
  describe("find_by_context", function()
    ...
    it("should find subtask by context with parent", function()
      ...
      mapping.register_task(map, key, "google456", "Shopping", "Get organic", "/file.md", 15, "Shopping|/file.md:10:top", context_sig)
  ...
  describe("find_task_key_by_google_id", function()
    it("should find task key by Google ID", function()
      ...
      mapping.register_task(map, key, "google123", "Shopping", "Buy milk", "/file.md", 10, nil, "Shopping||||Buy milk")
  ...
  describe("cleanup_orphaned_tasks", function()
    it("should remove tasks not in current list", function()
      ...
      mapping.register_task(map, "Shopping|/file.md:10:top", "google1", "Shopping", "Buy milk", "/file.md", 10, nil, "Shopping||||Buy milk")
      mapping.register_task(map, "Shopping|/file.md:15:top", "google2", "Shopping", "Buy eggs", "/file.md", 15, nil, "Shopping||||Buy eggs")
      mapping.register_task(map, "Shopping|/file.md:20:top", "google3", "Shopping", "Buy bread", "/file.md", 20, nil, "Shopping||||Buy bread")
    ...
    it("should not remove tasks from other lists", function()
      ...
      mapping.register_task(map, "Shopping|/file.md:10:top", "google1", "Shopping", "Buy milk", "/file.md", 10, nil, "Shopping||||Buy milk")
      mapping.register_task(map, "Work|/work.md:5:top", "google2", "Work", "Email boss", "/work.md", 5, nil, "Work||||Email boss")
